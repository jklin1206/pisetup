...
This is a pinned shortcut for \`/skill:impeccable ${command}\`.

Invoke /skill:impeccable ${command}, passing along any arguments provided here, and follow its instructions.
`;
}
